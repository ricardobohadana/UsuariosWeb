...
// ler a connection string mapeada no arquivo 'appsettings.json'
string connectionString = builder.Configuration.GetConnectionString("UsuariosWeb");

// injeção da connectionstring para as classes do repositorio e tambem já inicializa-las no projeto aspnet
